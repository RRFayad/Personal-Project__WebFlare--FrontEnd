...
const OldBusinessContext = React.createContext({
  // business parameters
...
export function OldBusinessContextProvider(props) {
...
export default OldBusinessContext;
